					...
					>
						...
						>
							<div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-yellow-500/20">
								<Heart className="h-7 w-7 fill-yellow-500 text-yellow-600" />
							</div>
							...
							<div className="mt-6 flex gap-3">
								<Button
									variant="outline"
									className="h-11 flex-1 rounded-xl font-body"
									onClick={() => setShowConfirm(false)}
								>
									Cancel
								</Button>
								<Button
									className="h-11 flex-1 gap-2 rounded-xl bg-yellow-500 font-body text-black hover:bg-yellow-600"
