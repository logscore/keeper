...
import { Plus, ChevronDown, ChevronUp, CalendarDays, User, Users } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background font-body">
      ...
      <main className="ml-64 p-8">
        {/* Page header */}
        <div className="mb-8">
          <h1 className="font-heading text-3xl font-bold text-foreground">Process Recordings</h1>
          <p className="font-body text-base text-muted-foreground mt-1">
            Document and review counseling sessions for each resident's healing journey.
          </p>
        </div>
              ...
              {filteredResidents.length === 0 ? (
                ...
                filteredResidents.map((resident) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-muted-foreground">{resident.caseNumber}</div>
                  </button>
                ))
              )}
            </div>
          ...
          {selectedResident === null ? (
            <div className="bg-card rounded-2xl border border-border shadow-sm p-12 flex flex-col items-center justify-center text-center">
              ...
              <p className="font-body text-sm text-muted-foreground max-w-xs">
                Choose a resident from the list to view their session history or add a new process recording.
              </p>
            </div>
          ) : (
              ...
              <div className="bg-[#FDFBF7] border-t-4 border-t-yellow-500 rounded-2xl px-6 py-4 flex items-center justify-between shadow-sm">
                <div>
                  ...
                  <p className="font-body text-sm text-muted-foreground">
                    ...
                    {residentRecordings.length} session{residentRecordings.length !== 1 ? "s" : ""} recorded
                  </p>
                </div>
                <Button
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid sm:grid-cols-2 gap-5">
                      ...
                      <div className="space-y-1.5">
                        <Label htmlFor="sessionDate" className="font-body text-sm font-medium text-foreground">
                      ...
                      {/* Social worker */}
                      <div className="space-y-1.5">
                        <Label htmlFor="socialWorker" className="font-body text-sm font-medium text-foreground">
                    ...
                    <div className="grid sm:grid-cols-2 gap-5">
                        ...
                        <div className="flex gap-3">
                          {(["individual", "group"] as SessionType[]).map((type) => (
                            <button
                              key={type}
                              type="button"
                              onClick={() => handleFieldChange("sessionType", type)}
                      ...
                      {/* Emotional state */}
                      <div className="space-y-1.5">
                        <Label htmlFor="emotionalState" className="font-body text-sm font-medium text-foreground">
                          Emotional State Observed <span className="text-red-500">*</span>
                        </Label>
                        <select
                          id="emotionalState"
                          required
                    ...
                    {/* Narrative summary */}
                    <div className="space-y-1.5">
                      <Label htmlFor="narrativeSummary" className="font-body text-sm font-medium text-foreground">
                      ...
                      <textarea
                        ...
                        onChange={(e) => handleFieldChange("narrativeSummary", e.target.value)}
                    ...
                    {/* Interventions */}
                    <div className="space-y-1.5">
                      <Label htmlFor="interventions" className="font-body text-sm font-medium text-foreground">
                        Interventions Applied <span className="text-red-500">*</span>
                      </Label>
                      <textarea
                        id="interventions"
                        required
                    ...
                    {/* Follow-up actions */}
                    <div className="space-y-1.5">
                      <Label htmlFor="followUpActions" className="font-body text-sm font-medium text-foreground">
                            ...
                            <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
                              ...
                              <div className="flex gap-2 flex-wrap">
                                <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-body font-medium border ${
                                  ...
                                  {rec.sessionType.charAt(0).toUpperCase() + rec.sessionType.slice(1)}
                                </span>
